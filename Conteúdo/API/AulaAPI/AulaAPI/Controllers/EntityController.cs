...
namespace AulaAPI.Controllers
{
    ...
    public class EntityController : ControllerBase
    {
        ...
        {
            if (!ModelState.IsValid) return BadRequest("Modelo inválido"); //TESTO SE ESTOU RECEBENDO CORRETAMENTE
        ...
        public async Task<IActionResult> posEmailinPessoa
            ([FromServices] Contexto contexto, [FromBody] Email email, [FromRoute] int id)
        {
